...
constexpr std::size_t POSE_COUNT = 1239;
...
// Repointed (2026-08-04) to test ONLY the reduced-DOF elbow_yaw-fixed
// batch (index 857-1238), in isolation from every prior quick-test
// dataset. QUICK_TEST_CSV below changed to a new filename so this run
// cannot overwrite quick_calibration_test_batch3.csv. Every prior
// quick-test pose set (realm-restricted 354-482, widened-range
// 483-656, batch3 657-856) is preserved in TARGET_POSES and can be
// restored here if needed again.
...
constexpr const char* QUICK_TEST_CSV = "quick_calibration_test_fixed_elbow_yaw.csv";
