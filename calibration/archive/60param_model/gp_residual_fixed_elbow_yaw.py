...
CSV_PATH = "C:/Users/ConformalUser/Desktop/cyton_setup/build/quick_calibration_test_fixed_elbow_yaw.csv"
...
print(f"\nPooled blocked-CV test RMS, physical model only: {pooled_phys:.2f}mm (reference: 0.78mm from the fixed-elbow-yaw physical-only run)")
print(f"Pooled blocked-CV test RMS, physical + GP residual: {pooled_gp:.2f}mm")
print(f"\nFold 0 physical-only: {fold5_phys_test_rms:.2f}mm (reference: no bad fold this time, all folds 0.70-0.92mm)")
print(f"Fold 0 physical + GP: {fold5_gp_test_rms:.2f}mm")
