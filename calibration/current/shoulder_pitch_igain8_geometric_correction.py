"""Robust alternative to refit_shoulder_pitch_igain8.py, after that
...
validation_points_deployed_batch2_first10.csv's recorded predictions --
...
measurements for the same 9 points -- build/validation_results_igain0_
baseline.csv (I=0) and build/validation_results_igain8_native.csv (I=8)
...
Run from calibration/current/:
    python3 shoulder_pitch_igain8_geometric_correction.py
"""
...
# ---------------------------------------------------------------------
with open("../../build/validation_results_igain0_baseline.csv") as f:
    base_rows = {r["test_id"]: r for r in csv.DictReader(f)}
with open("../../build/validation_results_igain8_native.csv") as f:
