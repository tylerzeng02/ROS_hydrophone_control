...
quick_calibration_test_fixed_elbow_yaw.csv -- WRONG dataset. The actual
predictions in validation_points_deployed_batch2_first10.csv (and hence
build/validation_results*.csv, which all trace back to it) were generated
...
(confirmed: build/validation_results_igain0_baseline.csv vs
build/validation_results_igain8_native.csv, same 9 points, ~10mm -> ~25mm
mean deviation).
...
FIT_CSV_PATHS = [
    "../../build/quick_calibration_test.csv",
    "../../build/quick_calibration_test_batch3.csv",
]
