...
CSV_PATH = "C:/Users/ConformalUser/Desktop/cyton_setup/build/quick_calibration_test_batch3.csv"
...
print(f"\nPooled blocked-CV test RMS, physical model only: {pooled_phys:.2f}mm (reference: 3.49mm from the earlier batch3-only run)")
print(f"Pooled blocked-CV test RMS, physical + GP residual: {pooled_gp:.2f}mm")
print(f"\nFold 0 physical-only: {fold5_phys_test_rms:.2f}mm (reference: 9.01mm, the worst fold from the earlier batch3-only run)")
